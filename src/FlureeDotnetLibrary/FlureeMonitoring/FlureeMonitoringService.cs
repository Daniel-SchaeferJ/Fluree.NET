...
namespace FlureeDotnetLibrary.FlureeMonitoring
{
    ...
    public class FlureeMonitoringService : BaseService, IFlureeMonitoringService
    {
        ...
        /// </summary>
        /// <returns>A JSON object of the statistics of the entire fluree network currently being run
        ...
        /// <returns>Returns a JSON object with statistics about the desired ledger
        ///
        /// </returns>
