...
public static class FlureeCommandModel
{
    ...
    {
        [JsonProperty("_id")] public string? CollectionId = "_collection";
        ...
        ///     intended predicates change over time this version number can be used to determine which schema version a particular
    ...
    {
        [JsonProperty("_id")] public string? PredicateId = "_predicate";

        /// <summary>
        ///     (required) Actual predicate name. Must be namespaced, and convention is to namespace it using the collection name
        ///     you intend it to be used within.
        ///     Technically any predicate can be placed on any subject, but using a spec can restrict this behavior. Note that if
        ///     you intend to use GraphQL tools,
        ///     predicate names must conform to /[_A-Za-z][_0-9A-Za-z]*/.
        ///     If you do not conform to this standard, queries issued to the /graphql endpoint will still work, but many GraphQL
        ///     tools will not.
        /// </summary>
        [JsonProperty("name")]
        ...
        /// <summary>
        ///     (optional) Doc string for this predicate describing its intention. This description is also used for GraphQL
        ...
        ///     tag A special tag predicate.Tags are auto-generated, and create auto-resolving referred entities.Ideal for use as
        ///     enum values. Also they allow you to find all entities that use a specific tag. (_type/tag)
        ...
        ///     json Arbitrary JSON data.The JSON is automatically encoded/decoded (UTF-8) with queries and transactions, and JSON
        ///     structure can be validated with a spec. (_type/json)
        /// </summary>
        [JsonProperty("type")]
...
{
    /// <summary>
    ///     Any subject id value which can include the numeric assigned permanent _id for an subject, any predicate marked as
    ///     unique as a two-tuple,
    ///     i.e. ["_user/username", "jdoe"], or a temporary id (for new entities). See the Temporary Ids section in the below
